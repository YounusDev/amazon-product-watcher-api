module.exports = async function (req, res) {
    ...
    if (!prevDomainUseFor.hasOwnProperty("pagesSpeedCheckService")) {
        prevDomainUseFor["pages_speed_check_service"] = {};
    }

    let modifiedDomainUseFor = prevDomainUseFor;

    modifiedDomainUseFor.pages_speed_check_service["status"] = status;
